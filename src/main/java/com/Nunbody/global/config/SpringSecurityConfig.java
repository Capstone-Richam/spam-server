...
public class SpringSecurityConfig {
    ...
    private static final String[] whiteList = {"/api/member/signup", "/api/member/signin", "/api/member/validate", "/api/mail/validate","/gmail", "/oauth/kakao","/api/kakao/send/**","/kakao-login"};
